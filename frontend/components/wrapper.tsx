...
// représente tout ce que react peut return, 
// ça garantit que ça va accepter tout ce qui va être mis => rend le typage large ou laxiste
  return (
    <SafeAreaView style={styles.safeView}> {/* SafeAreaView prend en compte les zones à éviter sur les differents mobiles */}
...
const styles = StyleSheet.create({
    safeView : {
        ...
        marginTop: Platform.OS === 'android' ? 30 : 0, // précise la plateforme, si c'est android on met margintop 30 sinon 0 pcq ios le fait automatiquement
    },
    container : {
        flex: 1,
