...
const ShopScreen = () => {
  ...
  // - Initialisation de la catégorie sélectionnée si elle est spécifiée dans les paramètres
  useEffect(() => {
    fetchCategories();
    fetchProducts();
    if (categoryParam) {
  ...
  //sortBY = rappel du switch case ds le productStore price-asc price desc rating
